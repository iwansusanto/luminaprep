        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              ...
              <button className="w-full sm:w-auto bg-white/10 backdrop-blur-md text-white border border-white/20 px-10 py-5 rounded-2xl font-bold text-xl hover:bg-white/20 transition-all active:scale-95">
                Contact Sales
              </button>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <div className="flex gap-8 text-sm text-muted-foreground">
              <a href="https://github.com/iwansusanto/luminaprep" className="hover:text-primary transition-colors">GitHub</a>
            </div>
