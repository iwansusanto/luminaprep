...
import {
  ...
  BrainCircuit, Loader2, AlertCircle, Save, XCircle, Bot, Sparkles,
} from 'lucide-react'
        ...
        {showFeedback && (
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 16 }}
            ...
            <div className="flex items-start gap-4">
              <div className={`w-10 h-10 rounded-2xl flex items-center justify-center shrink-0 ${isCorrect === true ? 'bg-emerald-500' : isCorrect === false ? 'bg-rose-500' : 'bg-amber-500'}`}>
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-3">
                  <p className={`text-xs font-black uppercase tracking-widest ${isCorrect === true ? 'text-emerald-700' : isCorrect === false ? 'text-rose-700' : 'text-amber-700'}`}>
