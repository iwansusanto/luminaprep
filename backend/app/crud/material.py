...
def create_material(db: Session, project_id: str, user_id: str, file_name: str, 
                   storage_path: str, file_type: str, file_size: Optional[int] = None,
                   citations: Optional[str] = None) -> Optional[Material]:
...
def update_material(db: Session, material_id: str, user_id: str, file_name: Optional[str] = None,
                   ...
                   file_size: Optional[int] = None, citations: Optional[str] = None) -> Optional[Material]:
    """Update a material."""
